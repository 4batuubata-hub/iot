<?php
// Script to fix and split history_summary for orphaned days
$host = "localhost"; $user = "root"; $pass = ""; $db = "simulasi";
$conn = new mysqli($host, $user, $pass, $db);
if ($conn->connect_error) die("Koneksi Gagal");

// 1. Sanitize history_quality anomalies
$conn->query("UPDATE history_quality SET prodCount = 0 WHERE prodCount < 0 OR prodCount > 10000");

// 2. Identify the mcID and the problematic timeframe
$mcID = '2 WS35 - 020';
...
foreach ($shifts_data as $key => $data) {
    ...
    if ($check && $check->num_rows > 0) {
        ...
        echo "Updated $tanggal $shift (Total OK: $total_ok)\n";
    } else {
        ...
        echo "Inserted $tanggal $shift (Total OK: $total_ok)\n";
    }
}
